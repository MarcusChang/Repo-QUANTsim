...
Sub Open
  ...
  Call MenuToolbarPopup.ClickItem("&Column Properties", False)
  Delay(100)
End Sub
...
Sub SetDecimals(ColumnName,DecimalsValue)
  ...
  Set dlgColumnProperties = Aliases.MarketView1.dlgColumnProperties
...
Public Function GetSelectedColumns()
   ...
   Dim dlgColumnPropertiesTab
   Set dlgColumnPropertiesTab = Aliases.MarketView1.dlgColumnProperties.TabControl.Calls
   
   SelectedColumns = dlgColumnPropertiesTab.SelectedFields.wItemList
   
   SelectTab("Puts")
   Set dlgColumnPropertiesTab = Aliases.MarketView1.dlgColumnProperties.TabControl.Puts
